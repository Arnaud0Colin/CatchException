...
function ExceptionTypeFilterWidget() {
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/CatchMe/GetExceptionType", function (data) {
...
function ComputerNameFilterWidget() {
    /***
    * This method must return type of registered widget type in 'SetFilterWidgetType' method
    */
    this.getAssociatedTypes = function () {
        return ["ComputerNameFilterWidget"];
    };
    /***
    * This method invokes when filter widget was shown on the page
    */
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '\
                    <p>Choisir un Odtinateur:</p>\
                    <select style="width:250px;" class="grid-filter-type customerslist form-control">\
                    </select>';
        this.container.append(html);
    };
    /***ComputerNameFilterWidget
    * Method loads all customers from the server via Ajax:
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/CatchMe/GetComputerName", function (data) {
            $this.fillCustomers(data.Items);
        });
    };
    /***
...
function ProgramFilterWidget() {
    ...
    */
    this.loadCustomers = function () {
        var $this = this; 
        $.post("/CatchMe/GetProgram", function (data) {
            $this.fillCustomers(data.Items);
        });
    };
    /***
...
function StatusFilterWidget() {
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/CatchMe/GetStatus", function (data) {
            $this.fillCustomers(data.Items);
        });
    };
    /***
